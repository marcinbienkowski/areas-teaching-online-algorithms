...
\item[Zadanie 3.] \textbf{(3 pkt.)} 
    ...
    Wskazówka: zastosuj zasadę minimaksową Yao stosując następujący rozkład:
    narciarz łamie nogę dnia $1 \leq i \leq B$ z prawdopodobieństwem 
    \begin{align*}
    p_i = & \frac{1}{B} \cdot \left( \frac{B-1}{B}\right)^{i-1} \enspace,
    \intertext{i nigdy nie łamie nogi z prawdopodobieństwem}
    p_\infty = & \left( \frac{B-1}{B} \right)^B \enspace.
    \end{align*}
